...
def checkropel():
    if tailcheck(head, knot1) == 0:
        knot1[0] = head[0]
        knot1[1] = head[1]
        knot1[0] -=1
        if tailcheck(knot1, knot2) == 0:
            knot2[0] = knot1[0]
            knot2[1] = knot1[1]
            knot2[0] -=1 
            if tailcheck(knot2, knot3) == 0:
                knot2[0] = knot1[0]
                knot2[1] = knot1[1]
                knot2[0] -=1
                if tailcheck(knot3, knot4) == 0:
                    knot2[0] = knot1[0]
                    knot2[1] = knot1[1]
                    knot2[0] -=1
                    if tailcheck(knot4, knot5) == 0:
                        tail[0] = head[0]
                        tail[1] = head[1]
                        tail[0] -=1 
                        if tailcheck(knot5, knot6) == 0:
                            tail[0] = head[0]
                            tail[1] = head[1]
                            tail[0] -=1
                            if tailcheck(knot6, knot7) == 0:
                                tail[0] = head[0]
                                tail[1] = head[1]
                                tail[0] -=1
                                if tailcheck(knot7, knot8) == 0:
                                    tail[0] = head[0]
                                    tail[1] = head[1]
                                    tail[0] -=1 
                                    if tailcheck(knot8, tail) == 0:
                                        tail[0] = head[0]
                                        tail[1] = head[1]
                                        tail[0] -=1
